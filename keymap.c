 ...
 */
  [0] = LAYOUT_ergodox(
          KC_GRAVE,KC_1,KC_2,KC_3,KC_4,KC_5,KC_INSERT,
          ...
          KC_TRANSPARENT,KC_PSCREEN,KC_TRANSPARENT,
 ...
 */
  ...
  [3] = LAYOUT_ergodox(
		KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
		KC_TRANSPARENT,KC_TRANSPARENT,UC(E_MAJ_ACCENT_GRAVE),UC(E_MAJ_ACCENT_AIGU),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
		KC_TRANSPARENT,UC(A_MAJ_ACCENT_GRAVE),UC(E_MAJ_TREMA),UC(E_MAJ_CIRCONFLEXE),KC_TRANSPARENT,KC_TRANSPARENT,
		MO(3),UC(A_MAJ_CIRCONFLEXE),KC_TRANSPARENT,UC(C_MAJ_CEDILLA),KC_TRANSPARENT,KC_TRANSPARENT,
		KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
		KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
		KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
		
		KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
		KC_TRANSPARENT,KC_TRANSPARENT,UC(U_MAJ_ACCENT_GRAVE),UC(I_MAJ_CIRCONFLEXE),UC(O_MAJ_CIRCONFLEXE),KC_TRANSPARENT,KC_TRANSPARENT,
		KC_TRANSPARENT,UC(U_MAJ_CIRCONFLEXE),UC(I_MAJ_TREMA),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
		KC_TRANSPARENT,KC_TRANSPARENT,UC(U_MAJ_TREMA),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
		KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
		KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
		KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT),
